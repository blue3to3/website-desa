...
$id = $_GET['id'];
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_pengantar_umum.* FROM penduduk LEFT JOIN surat_pengantar_umum ON surat_pengantar_umum.nik = penduduk.nik WHERE surat_pengantar_umum.id_spu='$id'");
                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Pengantar Umum</h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                <textarea name="fketerangan" class="form-control" rows="3" placeholder="Masukkan Keterangan Lain (Opsional)"><?php echo $row['keterangan']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <input type="hidden" name="id" value="<?php echo $row['id_spu']; ?>"
                                                class="form-control">
                                        </div>
