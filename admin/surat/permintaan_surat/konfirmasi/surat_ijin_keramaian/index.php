...
$id = $_GET['id'];
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_ijin_keramaian.* FROM penduduk LEFT JOIN surat_ijin_keramaian ON surat_ijin_keramaian.nik = penduduk.nik WHERE surat_ijin_keramaian.id_sik='$id'");
$uploadPath = "../../../../../uploads/surat_ijin_keramaian/";
                ...
                <div class="col-md-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Ijin Keramaian</h2>
                            ...
                            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box-body">
                                            ...
                                            <div>
                                                <input type="hidden" name="id" value="<?php echo $row['id_sik']; ?>"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="fnama_acara" style="text-transform: uppercase;"
                                                        value="<?php echo $row['nama_acara']; ?>" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                            <?php
                                            $tgl_db = $row['tanggal_acara'] ?? $row['tanggal_surat'] ?? date('Y-m-d');
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="ftanggal_acara"
                                                        style="text-transform: capitalize;"
                                                        value="<?php echo $tgl . $blnIndo[$bln] . $thn; ?>"
                                                        class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Hiburan Acara</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="fhiburan_acara"
                                                        style="text-transform: uppercase;"
                                                        value="<?php echo $row['hiburan_acara']; ?>" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Jumlah Undangan/Peserta</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="fjumlah_undangan"
                                                        style="text-transform: capitalize;"
                                                        value="<?php echo $row['jumlah_undangan']; ?>" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Tempat Acara</label>
                                                <div class="col-sm-9">
