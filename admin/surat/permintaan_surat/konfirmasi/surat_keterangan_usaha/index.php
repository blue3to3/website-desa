                  ...
                  <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="fusaha" style="text-transform: uppercase;"
                            value="<?php echo $row['usaha']; ?>" class="form-control" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <textarea rows="3" name="falamat" class="form-control"
                            style="text-transform: capitalize;"
                            readonly><?php echo $row['alamat_usaha']; ?></textarea>
                        </div>
                      </div>
                      <div>
