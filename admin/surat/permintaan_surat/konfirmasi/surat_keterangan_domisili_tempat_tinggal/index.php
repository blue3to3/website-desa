...
$id = $_GET['id'];
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_keterangan_domisili_tempat_tinggal.* FROM penduduk LEFT JOIN surat_keterangan_domisili_tempat_tinggal ON surat_keterangan_domisili_tempat_tinggal.nik = penduduk.nik WHERE surat_keterangan_domisili_tempat_tinggal.id_skd='$id'");
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Keterangan Domisili
                            Tempat Tinggal</h2>
