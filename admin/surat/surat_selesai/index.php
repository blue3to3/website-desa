            ...
            <div class="col-md-12">
                ...
                <table class="table table-striped table-bordered table-responsive" id="data-table" width="100%"
                    ...
                    <tbody>
                        ...
                        UNION SELECT penduduk.nama, surat_pengantar_umum.id_spu AS id_surat, surat_pengantar_umum.jenis_surat, surat_pengantar_umum.no_surat, surat_pengantar_umum.nik, surat_pengantar_umum.status_surat, surat_pengantar_umum.tanggal_surat FROM penduduk LEFT JOIN surat_pengantar_umum ON surat_pengantar_umum.nik = penduduk.nik WHERE surat_pengantar_umum.status_surat='selesai' 
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success" style="background:#28a745; padding:7px 14px; border-radius:25px; font-weight:600;">
                                <i class="fa fa-check"></i><b>
                                        <?php echo $row['status_surat']; ?></b></a></td>
                            <td>
                                <?php
                                    $folder = "";
                                    $js = trim($row['jenis_surat']);

                                    if ($js == "Surat Keterangan") {
                                        $folder = "surat_keterangan";
                                    } else if ($js == "Surat Pengantar") {
                                    ...
                                    } else if ($js == "Surat Ijin Keramaian") {
                                        $folder = "surat_ijin_keramaian";
                                    } else if ($js == "Surat Pengantar Catatan Kepolisian") {
                                        $folder = "surat_pengantar_catatan_kepolisian";
                                    }
                                    ?>
                                <a name="cetak" target="_blank" class="btn btn-primary btn-sm"
                                    href="../cetak/<?php echo $folder; ?>/index.php?id=<?php echo $row['id_surat']; ?>">
