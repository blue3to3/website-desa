...
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_pengantar_umum.* 
                                FROM penduduk 
                                LEFT JOIN surat_pengantar_umum ON surat_pengantar_umum.nik = penduduk.nik 
                                WHERE surat_pengantar_umum.id_spu='$id'");
if (!$qCek) {
