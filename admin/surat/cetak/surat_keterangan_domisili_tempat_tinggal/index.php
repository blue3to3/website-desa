...
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_keterangan_domisili_tempat_tinggal.* 
                                FROM penduduk 
                                LEFT JOIN surat_keterangan_domisili_tempat_tinggal ON surat_keterangan_domisili_tempat_tinggal.nik = penduduk.nik 
                                WHERE surat_keterangan_domisili_tempat_tinggal.id_skd='$id'");
if (!$qCek) {
...
<body>
    <div class="surat">
        ...
        <div align="center"><u>
                <h4 class="kop" style="font-size: 18px;">SURAT KETERANGAN DOMISILI TEMPAT TINGGAL</h4>
            </u></div>
        <div align="center">
        ...
        <div id="isi3">
            ...
            <table width="100%">
                <tr>
                    <td class="indentasi">Berdasarkan Surat Keterangan dari Ketua Rukun Warga
                        <?php echo "RT." . $row['rt'] . "/RW." . $row['rw']; ?>, bahwa yang bersangkutan benar
                        penduduk Desa <?php echo $rows['nama_desa']; ?> Kecamatan
                        <?php echo $rows['kecamatan']; ?> Kabupaten <?php echo $rows['kabupaten']; ?> yang beralamat pada alamat
                        tersebut diatas, surat ini dibuat untuk keperluan <?php echo $row['keperluan']; ?></a>.
                    </td>
                </tr>
            </table><br>
            <table width="100%">
                <tr>
                    <td class="indentasi">Demikian Surat Keterangan ini kami buat atas permintaan yang bersangkutan agar yang
                        berkepentingan mengetahui dan maklum.</td>
                </tr>
            </table>
        </div>
        <br>
