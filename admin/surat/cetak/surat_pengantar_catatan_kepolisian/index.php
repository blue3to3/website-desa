...
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_pengantar_catatan_kepolisian.* 
                                FROM penduduk 
                                LEFT JOIN surat_pengantar_catatan_kepolisian ON surat_pengantar_catatan_kepolisian.nik = penduduk.nik 
                                WHERE surat_pengantar_catatan_kepolisian.id_spck='$id'");
if (!$qCek) {
...
<body>
    <div class="surat">
        ...
        <div align="center"><u>
                <h4 class="kop3">SURAT PENGANTAR CATATAN KEPOLISIAN</h4>
            </u></div>
        <div align="center">
        ...
        <div id="isi3">
            ...
            <table width="100%">
                <tr>
                    <td class="indentasi">Surat keterangan ini diperlukan untuk <b><?php echo $row['keperluan']; ?>.</b>
                    </td>
                </tr>
            </table>
            <table width="100%">
                <tr>
                    <td class="indentasi">Demikian surat ini kami buat atas permintaan yang bersangkutan dan dapat digunakan
