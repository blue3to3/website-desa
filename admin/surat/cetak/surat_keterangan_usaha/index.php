...
$qCek = mysqli_query($connect, "SELECT penduduk.*, surat_keterangan_usaha.* 
                                FROM penduduk 
...
<body>
    <div class="surat">
        ...
        <div align="center"><u>
                <h4 class="kop3">SURAT KETERANGAN USAHA</h4>
            </u></div>
        <div align="center">
            ...
            <table width="100%">
                <tr>
                    <td class="indentasi">Berdasarkan Surat Keterangan dari Ketua Rukun Warga
                        <?php echo $row['rw']; ?>, Bahwa yang bersangkutan betul warga Desa <?php echo $rows['nama_desa']; ?>
                        dan menurut pengakuan yang bersangkutan mempunyai usaha <span style="text-transform: uppercase;"><?php echo $row['usaha']; ?>.</span>
                    </td>
                </tr>
            </table>
            <table width="100%">
                <tr>
                    <td class="indentasi">Surat keterangan ini diperlukan untuk <span style="text-transform: uppercase;"><?php echo $row['keperluan']; ?>. </span>
                    </td>
                </tr>
            </table>
            <br>
