...
<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="../laporan/"><i class="fas fa-chart-line"></i> <span>&nbsp; Laporan</span></a></li>
        </ul>
    </section>
</aside>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-3" align="right">
                    ...
                    <a href="../laporan/" name="filter" class="btn btn-danger btn-md"><i class="fas fa-eraser"></i>
                        Reset Filter</a>
                </div><br>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-transform: capitalize;">
                                <?php echo "Desa " . $data['desa'] . ", RT." . $data['rt'] . "/RW." . $data['rw']; ?>
                            </td>
                        </tr>
                        <?php
                            }
