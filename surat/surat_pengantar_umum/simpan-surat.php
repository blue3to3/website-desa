...
if (isset($_POST['submit'])) {
    ...
    $uploadDir = "../../uploads/surat_pengantar_umum/";
    ...
    $qTambahSurat = "INSERT INTO surat_pengantar_umum 
    (jenis_surat, nik, bukti_ktp, bukti_kk, surat_rt, surat_rw, keperluan, status_surat, id_profil_desa, kode_tracking, no_hp) 
    VALUES
    ('$jenis_surat', '$nik', '$newKtpName', '$newKkName', '$newRtName', '$newRwName', '$keperluan', '$status_surat', '$id_profil_desa', '$kode_tracking', '$no_hp')";
