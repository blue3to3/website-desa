...
if (isset($_POST['submit'])) {
    ...
    $uploadDir = "../../uploads/surat_keterangan_usaha/";
    ...
    // Insert ke tabel surat_keterangan_uasaha
    $qTambahSurat = "INSERT INTO surat_keterangan_usaha
    (jenis_surat, nik, bukti_ktp, bukti_kk, surat_rt, surat_rw, usaha, alamat_usaha, keperluan, status_surat, id_profil_desa, kode_tracking, no_hp)
    VALUES('$jenis_surat', '$nik', '$newKtpName', '$newKkName', '$newRtName', '$newRwName', '$usaha', '$alamat_usaha', '$keperluan', '$status_surat', '$id_profil_desa', '$kode_tracking', '$no_hp')";
