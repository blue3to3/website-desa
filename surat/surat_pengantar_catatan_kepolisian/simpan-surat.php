...
if (isset($_POST['submit'])) {
    $jenis_surat = "Surat Pengantar Catatan Kepolisian";
    $nik = $_POST['fnik'];
    ...
    $uploadDir = "../../uploads/surat_pengantar_catatan_kepolisian/";
    ...
    $qTambahSurat = "INSERT INTO surat_pengantar_catatan_kepolisian 
    (jenis_surat, nik, bukti_ktp, bukti_kk, surat_rt, surat_rw, keperluan, keterangan, status_surat, id_profil_desa, kode_tracking, no_hp) 
    VALUES
    ('$jenis_surat', '$nik', '$newKtpName', '$newKkName', '$newRtName', '$newRwName', '$keperluan', '$keterangan', '$status_surat', '$id_profil_desa', '$kode_tracking', '$no_hp')";
