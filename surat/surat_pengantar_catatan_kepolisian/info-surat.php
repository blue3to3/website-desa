        ...
        <div class="card-body p-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                <h4 class="font-weight-bold text-success mb-0">
                    <i class="fas fa-file-contract"></i> Pengantar SKCK
                </h4>
            ...
            <form method="post" action="simpan-surat.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           name="fkeperluan"
                           class="form-control"
                           value="Permohonan SKCK"
                           readonly>
                </div>

                <div class="form-group">
                    <label class="font-weight-bold">Keterangan / Tujuan</label>
                    <input type="text"
                           name="fketerangan"
                           class="form-control"
                           placeholder="Contoh: Untuk melamar pekerjaan di PT. Maju Jaya"
                           required>
                </div>
