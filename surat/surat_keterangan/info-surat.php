        ...
        <div class="card-body p-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                <h4 class="font-weight-bold text-success mb-0">
                    <i class="fas fa-envelope-open-text"></i> Surat Keterangan
                </h4>
            ...
            <form method="post" action="simpan-surat.php" enctype="multipart/form-data">
                ...
                <h6 class="text-success font-weight-bold text-uppercase mb-4">Informasi Pribadi Penduduk</h6>
                ...
                <div class="mt-4">
                    <label class="font-weight-bold">Apa keperluan Anda membuat surat ini?</label>
                    <input type="text" name="fkeperluan" class="form-control"
                           placeholder="Masukkan keperluan pembuatan surat..." required>
                </div>
