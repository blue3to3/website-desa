        ...
        <div class="card-body p-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                <h4 class="font-weight-bold text-success mb-0">
                    <i class="fas fa-hand-holding-heart"></i> Surat Keterangan Tidak Mampu
                </h4>
            ...
            <form method="post" action="simpan-surat.php" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    <label class="font-weight-bold">Keperluan Surat (SKTM)</label>
                    <input type="text"
                           name="fkeperluan"
                           class="form-control"
                           placeholder="Contoh: Persyaratan Beasiswa / Keringanan Biaya Rumah Sakit"
                           required>
                </div>
